...
# Kando
from kando.projects.rules import is_project_member, is_project_owner_or_admin
...
@rules.predicate
def is_column_project_member(user, column):
    return is_project_member(user, column.project)
...
rules.add_perm("columns.view_column", is_column_project_member)
