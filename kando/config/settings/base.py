...
ROOT_URLCONF = "kando.config.urls"
...
MIDDLEWARE = [
    ...
    "kando.common.middleware.http.HttpResponseNotAllowedMiddleware",
]
...
SOCIALACCOUNT_ADAPTER = "kando.users.adapters.SocialAccountAdapter"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "libraries": {"pagination": "kando.common.pagination.templatetags"},
        },
    }
]
